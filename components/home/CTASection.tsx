...
export function CTASection() {
  ...
  return (
    <section className="rounded-3xl border border-slate-200/70 bg-gradient-to-r from-slate-900 via-slate-800 to-blue-900 p-10 text-white shadow-2xl shadow-blue-500/10 md:p-14">
      ...
      <Link href="/admin" className="mt-8 inline-flex rounded-xl bg-white px-6 py-3 text-sm font-semibold text-slate-900 transition hover:translate-y-[-1px] hover:bg-blue-50">
        {t.home.ctaAction}
      </Link>
    </section>
  );
